	...
	render() {
		return (
			<div className={styles.content}>
				...
				<p>Kyiv Metro ("us", "we", or "our") operates the Kyiv Metro mobile application (hereinafter referred to as the "Service").</p>
				...
				<p>Kyiv Metro uses the collected data for various purposes:</p>
				<ul>
				...
				<p>Kyiv Metro will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

				<h2>Disclosure Of Data</h2>

				<h3>Legal Requirements</h3>
				<p>Kyiv Metro may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
				<ul>
						<li>To comply with a legal obligation</li>
						<li>To protect and defend the rights or property of Kyiv Metro</li>
				...
				<ul>
				<li>By email: dev@mamalat.com</li>
